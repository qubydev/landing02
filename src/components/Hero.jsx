...
export default function Hero() {
    return (
        <div
            className='h-screen bg-cover bg-center bg-no-repeat relative before:absolute before:inset-0 before:bg-[url(/hero-bg.svg)] before:bg-cover before:bg-center before:bg-no-repeat before:z-[5]'
        >
            <ShootingStars count={30} />
            <div className='px-3 pt-28 relative z-10'>
                ...
                <div className='flex items-center justify-center flex-col'>
                    <div>
                        <p className='text-3xl font-playfair italic text-foreground/80 font-bold tracking-tight'>not just a</p>
                        <GradientText
                    ...
                    <div className='py-6 flex flex-col items-center justify-center gap-3'>
                        <p className='flex items-center justify-center flex-col text-foreground/80'>
                            <span>Teaching my 7 years of experience in 3 months!</span>
                            <span>Wealth has a language, it’s time you learned to speak it.</span>
                        </p>
                        <Button size="lg" className={"rounded-full text-lg px-18 py-6"}>Join Now</Button>
                    </div>
                </div>
            </div>
        </div>
